...
router
  ...
  // Is this supposed to be unauthorized???
  // If yes, I'd move to own file so you could protect 
  // this whole router in app.js instead of here
  // If no, moving to app.js would have prevented mistake
  ...
  // I might have done '/:id/follow' here
  ...
  // and possbily moved this to thread/:id/follow ...
    ...
    User.findById(currUser)
      .then(user => {
        if (user.usersFollowed.indexOf(userToUnFollow) < 0) {
          ...
          // removedUsers isn't used... I suspect you wanted to use $pull
